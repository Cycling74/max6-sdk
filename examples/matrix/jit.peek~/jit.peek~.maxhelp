...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 480.996979, 187.723602, 55.0, 18.0 ],
					"text" : "interp $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 17.0, 366.0, 80.0, 35.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 298.86969, 201.936401, 89.0, 20.0 ],
					"text" : "(which column)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 93.0, 171.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 343.0, 106.0, 286.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 512.0, 268.0, 90.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 374.193939, 155.744797, 44.0, 20.0 ],
					"text" : "sig~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 17.0, 181.0, 112.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 388.809082, 181.801605, 41.0, 20.0 ],
					"text" : "dim[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 303.366669, 181.801605, 41.0, 20.0 ],
					"text" : "dim[0]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 291.0, 155.744797, 47.0, 20.0 ],
					"text" : "*~ 320."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 291.0, 128.503586, 62.0, 20.0 ],
					"text" : "phasor~ 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 17.0, 147.0, 64.0, 20.0 ],
					"text" : "qmetro 20"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 392.424255, 227.440002, 216.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 388.809082, 201.936401, 70.0, 20.0 ],
					"text" : "(which row)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 540.581848, 141.531998, 111.0, 73.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 57.0, 572.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 341.326935, 22.0, 158.673065, 14.666666 ],
					"presentation_rect" : [ 0.0, 0.0, 158.673065, 14.666666 ],
					"spacing_x" : 0.0,
					"spacing_y" : 0.0,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.595187,
					"id" : "obj-57",
					"items" : [ "(Objects:)", ",", "jit.buffer~", ",", "jit.poke~", ",", "peek~", ",", "poke~", ",", "<separator>" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
